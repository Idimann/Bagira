...
pub const TT_Entry = struct {
    ...
    val: packed struct {
        hash: u32 = 0,
        score: se2.Searcher.BoundProb = .{ .p = 0.0, .bound = 1 },
    ...
    pub inline fn usable(self: *const TT_Entry, bound: se2.Searcher.Prob) bool {
...
pub inline fn store(
    ...
    const tte_val = (1 - tte.reader.?.val.score.bound) -
        @as(se2.Searcher.Prob, @floatFromInt(time_diff)) * 0.25;
